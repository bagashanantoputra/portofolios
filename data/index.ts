export const navItems = [
  ...
  export const projects = [
    {
      ...
      des: "Dompetku is Modern Financial Management the tech using NextJS and Golang.",
      img: "/Dompetku.png",
  ...
  export const workExperience = [
    ...
    },
    {
      ...
      desc: "Designed and developed web app for internal platforms using ReactJS and PHP",
      className: "md:col-span-2",
      thumbnail: "/exp2.svg",
    },
    {
    ...
    },
    {
      ...
      desc: "Developed and maintained user-experience features using modern technologies for big banking app.",
      className: "md:col-span-2",
      thumbnail: "/exp4.svg",
    },
  ];
